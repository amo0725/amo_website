...
const Footer = () => {
    return (
        <div className="font-mono pt-12 sm:pb-36 sm:py-12 py-6 bg-gray-300 dark:bg-gray-900 lg:pt-18">
            <div className="max-w-4xl px-4 mx-auto text-gray-800 dark:text-white">
                <div className="pb-8 mb-2 border-t-4 border-gray-50 dark:border-white-300"></div>
                <div className="flex flex-col justify-between lg:flex-row items-center">
                    <p>© Amo Feng. All Rights Reserved.</p>
